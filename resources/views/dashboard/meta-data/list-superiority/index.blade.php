...
@section('title', 'List Superiority')

@section('css')

@section('breadcumb')
    <div class="page-header">
        <h1 class="my-auto page-title">List Superiority</h1>
        <div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $("#datatable").DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('superiority.datatable') }}",
                columnDefs: [{
                        targets: 0,
